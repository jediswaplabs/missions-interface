...
const MintCard = ({ title, description, address, nftImg }) => {
  ...
  return (<QuestBox style={{ width: '700px', padding: '30px', marginTop: '20px', display: 'flex', justifyContent: 'space-between' }}>
    <div>
      <QuestCardTitle>
        {title}
      </QuestCardTitle>
      ...
      {isClaimed &&
        <QuestBox style={{ width: '314px', padding: '6px', display: 'flex', justifyContent: 'center', alignContent: 'center' }}>
