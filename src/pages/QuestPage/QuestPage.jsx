...
const QuestPage = () => {
  ...
  const mintData = {
    ...
    // ],
    proof: ['0x7aafb266518806486b3d98b4aa4ae938d8b0ec2d190b3350c5d4edbf666b36e','0xe85e9c9e32736b77b3d0462bca847b5e189e170b7212ab9601a22a745a39c5','0x19d53d0ecde940a8f578331a0bf62dd4f9d38f7f0d2c187d6582ef2fc86b490'],
    token_metadata: {
      type: 'struct',
  ...
  const calls = useMemo(() => {
    const tx = {
      ...
      contractAddress: '0x06c4f71c1c4a14bba747b4d18dfb73b486aa2ba921dd0de4f64dc415536b8ba6',
