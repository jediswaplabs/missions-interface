...
const ProfileCard = ({ account, readOnly = true }) => {
  ...
  if (isError) {
    ...
    content = (
      <>
        <div
          data-testid={isFetching || isUninitialized ? "loading_account" : null}
        />
        <AccountAvatar>
          <UserAvatar
            src={userAvatarUrl}
            isMock={isFetching || isUninitialized}
          />
        </AccountAvatar>
        <AccountAddress>
  ...
  return (
    <BoxContainer>
      <Cover />
      <AccountInfoContainer>{content}</AccountInfoContainer>
      <WalletContainer>
